...
const aboutPageMk: typeof aboutPage = {
  ...
  world: {
    ...
    body: "Не постојат две исти патувања, затоа што не постојат двајца исти патници. Секое искуство го создаваме според вас — вашето темпо, луѓето со кои патувате и чувството што сакате да го доживеете. Од првата идеја до последниот детал, сè е внимателно обликувано за патувањето да биде единствено и целосно ваше.",
  },
};
...
const reasonsMk: Reason[] = [
  ...
  },
  {
    ...
    body: "Креираме целосно персонализирани патувања, внимателно приспособени на желбите, потребите и очекувањата на секој клиент.\n\nСо искрени препораки, личен пристап и внимание кон секој детал, се стремиме секое патување да биде подобро од замисленото. Она што нè издвојува е љубовта кон градењето долгорочни односи со нашите клиенти и постојаното унапредување на идните искуства врз основа на нивните повратни мислења.",
  },
];
...
const whyNotDiyMk: typeof whyNotDiy = {
  ...
  topics: [
    ...
    },
    {
      ...
      body: "Колку вреди совршеното патување? Нашите внимателно осмислени програми се исполнети со уникатни идеи и искуства, целосно приспособени на вас.\n\nНа прв поглед, понудата можеби изгледа како значителна инвестиција, но секој детал е внимателно избран за да добиете максимална вредност за вашиот буџет. Самостојното резервирање на сите услуги честопати би ве чинело повеќе — а постои и можност да пропуштите некое навистина посебно искуство.",
    },
    {
      ...whyNotDiy.topics[3],
      nav: "Без грижи",
...
const howItWorksMk: ProcessStep[] = [
  ...
  },
  {
    ...
    body: "Никогаш не ве оставаме сами во процесот. Тука сме заедно да ја усовршуваме вашата програма сè додека секој детал не биде токму онаков каков што сте го замислиле.\n\nА кога ќе започне патувањето, остануваме достапни — доволен е само еден повик доколку ви затреба нашата помош.",
  },
];
