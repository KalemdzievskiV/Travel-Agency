              ...
              >
                {days.map((d, idx) => {
                  ...
                  return (
                    ...
                    >
                      <span style={{ display: "block", fontFamily: "var(--wf-font-sans)", fontSize: 11, fontWeight: 700, letterSpacing: "0.14em", textTransform: "uppercase", color: on ? "var(--wf-accent-ink)" : "var(--wf-ink-500)" }}>
                        {d.label || `${dayWord} ${d.n}`}
                      </span>
